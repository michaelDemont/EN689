...
class NormStat (numMeasures: Int, resMeasures: List<Double>, gwMeasures: Double, cheat: Boolean, mean:Double) {
        val numM: Int
        ...
        lateinit var PkList: MutableList<Double>
